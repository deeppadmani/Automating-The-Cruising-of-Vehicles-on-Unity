...
public class  Jobs
{
        ...
        public const float STATE_MOVING_FORWARD_WITH_2F_SPEED = 4; 
        ...
        public const float STATE_CAR_DETECTED = 8;
        public const float STATE_PEDS_DETECTED = 19;
    ...
    public void Execute(DeviceRegistry devices) 
    {
        ...
        if(Jobs.STATE_INITIAL_DIRECTION_CALIBRATION == devices.memory[0])
        {
            ...
            (devices.compass[0] > 89f) )
            {
                devices.steeringControl[0] = 1f;
                devices.steeringControl[1] = 0f;
                devices.memory[0] = Jobs.STATE_MOVING_FORWARD_WITH_2F_SPEED;      //mov fwd
            }
